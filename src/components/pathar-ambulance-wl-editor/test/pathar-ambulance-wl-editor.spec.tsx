...
import { PatharAmbulanceWlEditor } from '../pathar-ambulance-wl-editor';
...
describe('pathar-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [PatharAmbulanceWlEditor],
      html: `<pathar-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
     ...
     const page = await newSpecPage({
        components: [PatharAmbulanceWlEditor],
        html: `<pathar-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></pathar-ambulance-wl-editor>`,
     });
